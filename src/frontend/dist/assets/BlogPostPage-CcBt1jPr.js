import { c as createLucideIcon, u as useParams, j as jsxRuntimeExports, L as Link } from "./index-DMJMRxWv.js";
...
const blogData = [
  ...
  },
  {
    ...
    excerpt: "We compare the top 10 prop trading firms of 2026 by payout speed, profit split, rules fairness, and real trader reviews.",
    category: "Prop Firm",
    author: "FX Expert Team",
    authorInitials: "FX",
    date: "May 2, 2026",
  ...
  },
  {
    ...
    excerpt: "Complete beginner's guide to forex trading. Build a strategy, practice on demo, and land your first funded account with FX Expert Funded.",
    category: "Forex",
    author: "FX Expert Team",
    authorInitials: "FX",
    date: "Apr 28, 2026",
  ...
  },
  {
    ...
    excerpt: "Everything about instant funding accounts — how they work, rules to follow, and whether they're worth it vs. standard challenges.",
    category: "Prop Firm",
    author: "David Park",
    authorInitials: "DP",
    date: "Apr 25, 2026",
  ...
  },
  {
    ...
    excerpt: "Not all firms pay weekly. We investigated 15 prop firms and ranked them by actual payout reliability, processing speed, and trader satisfaction.",
    category: "Prop Firm",
    author: "FX Expert Team",
    authorInitials: "FX",
    date: "Apr 20, 2026",
  ...
  },
  {
    ...
    excerpt: "Master your mindset while trading a prop firm account. Expert tips on discipline, loss recovery, consistency and avoiding revenge trading.",
    category: "Psychology",
...
function BlogPostPage() {
  ...
  if (!post) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-20 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-black text-4xl mb-4", children: "Post Not Found" }),
  ...
  const related = blogData.filter((p) => p.category === post.category && p.slug !== slug).slice(0, 3);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("title", { children: [
      post.title,
      " | FX Expert Funded Blog"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "gradient-hero py-16 border-b border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 sm:px-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between flex-wrap gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-brand-navy border border-brand-gold/30 flex items-center justify-center text-brand-gold font-bold text-sm", children: post.authorInitials }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-sm font-semibold", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "w-3.5 h-3.5 text-foreground/40" }),
              post.author
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 text-xs text-foreground/40", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-14", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4 sm:px-6 grid lg:grid-cols-3 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-elevated rounded-2xl p-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/70 text-lg leading-relaxed mb-8 border-l-2 border-brand-gold pl-5", children: post.excerpt }),
          post.content.map((section) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-xl mb-3 text-foreground", children: section.heading }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground/65 leading-relaxed text-[0.9375rem]", children: section.body })
          ] }, section.heading)),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-white/10 pt-6 mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-foreground/30", children: [
            "Published by ",
            post.author,
            " • ",
            post.date,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "gradient-navy rounded-2xl p-7 text-center mt-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/60 mb-3", children: "Ready to apply what you've learned?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "font-display font-bold text-xl mb-5", children: [
            "Get a",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient-gold", children: "Funded Account Today" })
          ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-elevated rounded-xl p-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-sm mb-3 text-foreground/80", children: "Table of Contents" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: post.content.map((section, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-gold/60 font-mono", children: String(i + 1).padStart(2, "0") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "line-clamp-2", children: section.heading })
              ]
            },
            `toc-${section.heading}`
          )) })
        ] }),
        related.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-elevated rounded-xl p-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-sm mb-4 text-foreground/80", children: "Related Articles" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: related.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to: "/blog/$slug",
              params: { slug: p.slug },
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-brand-gold mb-1", children: p.category }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold line-clamp-2 leading-snug", children: p.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-foreground/40 mt-1", children: p.readTime })
              ]
            },
            p.id
          )) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-elevated rounded-xl p-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-sm mb-3 text-foreground/80", children: "Share This Article" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: ["Twitter", "Telegram", "WhatsApp"].map((platform) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
